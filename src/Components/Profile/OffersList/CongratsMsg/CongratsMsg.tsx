...
function CongratsMsg(props: props): JSX.Element {
  return (
    <div className="CongratsMsg">
      ...
      {props.user?._id === props.bidder._id && (
        <>
          <p className="congrats-paragraph">
            ...
            to
            <span className="show-name">{props.event.event_name}</span>
      ...
      {props.user?._id === props.owner._id && (
        <>
          <p className="congrats-paragraph">
            Dear {props.user?.first_name}, <br />
            ...
            {` ${props.bidder.first_name} ${props.bidder.last_name} `}
            to make the payment.
          </p>
          <p className="congrats-paragraph">
